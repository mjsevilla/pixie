...
class MatchesToBioTransitionOperator: NSObject, UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate  {
   ...
   func animateTransition(transitionContext: UIViewControllerContextTransitioning) {
      ...
      var imageScale = CGAffineTransformConcat(CGAffineTransformMakeScale(imageFrame.width/profilePic.frame.width, imageFrame.height/profilePic.frame.height), CGAffineTransformMakeTranslation(0, matchesViewController.topMargin-profilePic.frame.width/14.0))
