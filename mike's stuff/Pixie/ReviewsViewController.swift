...
class ReviewsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UIGestureRecognizerDelegate {
   ...
   let reviews: [Review] = [Review(comment: "Super chill. Drove together for over 5 hours but it seemed more like 1. I'd definitley ride together again.", color: Review.reviewColor.green), Review(comment: "Eh, it was whatever. Music tastes clashed but got over it pretty fast.", color: Review.reviewColor.yellow), Review(comment: "We were about to get pulled over, but then she sped through a gap between two semi-trucks and got away from it lol best ride ever.", color: Review.reviewColor.green), Review(comment: "I would NEVER drive with her again. She sped away from a cop and the other rider with us just cheered her on. Avoid this driver if you value your life.", color: Review.reviewColor.red)]
