...
class PostRideViewController: UIViewController, UITextFieldDelegate, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func loadReviewSectionConstraints() {
        let viewsDict = ["reviewSectionButton":reviewSectionButton, "seekOfferLabel":seekOfferLabel, "tripLabel":tripLabel, "dateLabel":dateLabel, "timeLabel":timeLabel, "postRideButton":postRideButton]
